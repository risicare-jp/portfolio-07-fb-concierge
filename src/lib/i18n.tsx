...
const en: Dict = {
  ...
  "nav.gallery": "GALLERY",
  "nav.drawer_caption": "鎮座ヒノカミ · HINOKAMI · King West Toronto",
  "nav.open_menu": "Open menu",
  "nav.close_menu": "Close menu",
  "nav.social_instagram": "Instagram",
  "nav.social_facebook": "Facebook",
  "nav.social_x": "X (Twitter)",

  "gallery.heading": "Gallery",
  "gallery.subheading": "Sixteen years of fire, served on a plate.",
  "gallery.filter_all": "All",
  "gallery.filter_cuisine": "Cuisine",
  "gallery.filter_atmosphere": "Atmosphere",
  "gallery.filter_chef": "The Chef",
  "gallery.image_coming_soon": "image coming soon",
  "gallery.cat.cuisine": "Cuisine",
  "gallery.cat.atmosphere": "Atmosphere",
  "gallery.cat.chef": "The Chef",
  "gallery.prev": "Previous",
  "gallery.next": "Next",
  "gallery.close": "Close",

  "concierge.continue_reservation_assistant": "Continue to Reservation Assistant →",

  "ra.step1_prompt": "What date would you like to visit?",
  "ra.step2_prompt": "What time would you like to come?",
  "ra.step3_prompt": "How many guests in your party? (1-8)",
  "ra.step4_prompt": "Which seating would you prefer?",
  "ra.step5_prompt": "Please share your contact details.",
  "ra.step6_prompt": "Anything we should know? Allergies, occasion, accessibility, dietary preferences — feel free to share.",
  "ra.step6_placeholder": "Birthday celebration, peanut allergy, etc.",
  "ra.step7_prompt": "Please confirm your reservation details:",
  "ra.label_name": "Name",
  "ra.label_email": "Email",
  "ra.label_phone": "Phone (optional)",
  "ra.continue": "Continue →",
  "ra.back": "← Back",
  "ra.skip": "Skip →",
  "ra.confirm": "Confirm reservation →",
  "ra.confirming": "Confirming…",
  "ra.cancel_note": "Free cancellation up to 24 hours before. Within 24 hours: CAD $50 per person.",
  "ra.cancel_note_private": "Private rooms: free cancellation up to 72 hours; 50% within 72 hours; 100% same day.",
  "ra.seat.counter_name": "Counter omakase",
  "ra.seat.counter_capacity": "1-2 guests",
  "ra.seat.counter_price": "CAD $135-175 / person",
  "ra.seat.counter_desc": "Front-row view of the straw flame. 8-course tasting paced by the chef.",
  "ra.seat.table_name": "Table seating",
  "ra.seat.table_capacity": "2-6 guests",
  "ra.seat.table_price": "CAD $70-100 / person",
  "ra.seat.table_desc": "Open dining room. À la carte share-style.",
  "ra.seat.private_name": "Private tatami room",
  "ra.seat.private_capacity": "4-8 guests",
  "ra.seat.private_price": "CAD $90-130 / person + $30 room fee",
  "ra.seat.private_desc": "Shoji-door private room. Chef's omakase recommended.",
  "ra.summary.date": "Date",
  "ra.summary.time": "Time",
  "ra.summary.party": "Party size",
  "ra.summary.seating": "Seating",
  "ra.summary.name": "Name",
  "ra.summary.email": "Email",
  "ra.summary.phone": "Phone",
  "ra.summary.requests": "Special requests",
  "ra.result_heading": "Reservation confirmed",
  "ra.result_body": "We've reserved {seating} for {party_size} guests on {date} at {time}. A confirmation email has been sent to {email}.",
  "ra.result_confirmation_num": "Confirmation #{conf_num}",
  "ra.result_next_steps": "Need an allergen check across your party? Tell me \"allergen check\" and I'll open the Order Assistant.",
  "ra.result_close": "Done",
  "ra.mock_notice": "(Demo only — no actual reservation is recorded)",
  "ra.guest_one": "{n} guest",
  "ra.guest_many": "{n} guests",
  "ra.party_label": "Guests",
};
...
const ja: Dict = {
  ...
  "nav.gallery": "ギャラリー",
  "nav.drawer_caption": "鎮座ヒノカミ · HINOKAMI · トロント",
  ...
  "gallery.subheading": "16年の炎、ひと皿の上で。",
  "gallery.filter_all": "すべて",
  "gallery.filter_cuisine": "料理",
  "gallery.filter_atmosphere": "店内",
  "gallery.filter_chef": "料理人",
  "gallery.image_coming_soon": "画像準備中",
  "gallery.cat.cuisine": "料理",
  "gallery.cat.atmosphere": "店内",
  "gallery.cat.chef": "料理人",
  "gallery.prev": "前へ",
  "gallery.next": "次へ",
  "gallery.close": "閉じる",

  "concierge.continue_reservation_assistant": "予約アシスタントへ →",

  "ra.step1_prompt": "ご来店日をお選びください。",
  "ra.step2_prompt": "お時間は何時頃をご希望ですか?",
  "ra.step3_prompt": "何名様でお越しになりますか? (1-8名)",
  "ra.step4_prompt": "お席の種類をお選びください。",
  "ra.step5_prompt": "ご連絡先をお教えください。",
  "ra.step6_prompt": "アレルギー・記念日・アクセシビリティ・食事制限など、ご要望があればお書きください。",
  "ra.step6_placeholder": "誕生日のお祝い、ピーナッツアレルギーなど",
  "ra.step7_prompt": "ご予約内容のご確認をお願いします:",
  "ra.label_name": "お名前",
  "ra.label_email": "メールアドレス",
  "ra.label_phone": "電話番号 (任意)",
  "ra.continue": "次へ →",
  "ra.back": "← 戻る",
  "ra.skip": "スキップ →",
  "ra.confirm": "予約を確定 →",
  "ra.confirming": "確認中…",
  "ra.cancel_note": "24時間前まで無料キャンセル。24時間以内: 1名様 CAD $50 のキャンセル料。",
  "ra.cancel_note_private": "個室: 72時間前まで無料、72時間以内は50%、当日は100%のキャンセル料。",
  "ra.seat.counter_name": "カウンター おまかせ",
  "ra.seat.counter_capacity": "1-2名様",
  "ra.seat.counter_price": "CAD $135-175 / 1名様",
  "ra.seat.counter_desc": "わら炎の特等席。シェフ主導の8品コース。",
  "ra.seat.table_name": "テーブル席",
  "ra.seat.table_capacity": "2-6名様",
  "ra.seat.table_price": "CAD $70-100 / 1名様",
  "ra.seat.table_desc": "オープンダイニング、4-5品シェアスタイル。",
  "ra.seat.private_name": "個室 (畳の間)",
  "ra.seat.private_capacity": "4-8名様",
  "ra.seat.private_price": "CAD $90-130 / 1名様 + 個室料 $30",
  "ra.seat.private_desc": "障子で仕切られた個室、シェフのおまかせ推奨。",
  "ra.summary.date": "日付",
  "ra.summary.time": "時間",
  "ra.summary.party": "ご人数",
  "ra.summary.seating": "お席",
  "ra.summary.name": "お名前",
  "ra.summary.email": "メール",
  "ra.summary.phone": "電話",
  "ra.summary.requests": "ご要望",
  "ra.result_heading": "予約が確定しました",
  "ra.result_body": "{date} {time} に {party_size} 名様で {seating} のご予約を承りました。確認メールを {email} にお送りしました。",
  "ra.result_confirmation_num": "予約番号 #{conf_num}",
  "ra.result_next_steps": "アレルゲン詳細チェックが必要な場合は「アレルゲン」とお伝えください、Order Assistant を開きます。",
  "ra.result_close": "完了",
  "ra.mock_notice": "(デモ用 — 実際の予約は登録されません)",
  "ra.guest_one": "{n} 名",
  "ra.guest_many": "{n} 名",
  "ra.party_label": "人数",
};
...
const cn: Dict = {
  ...
  "nav.gallery": "画廊",
  "nav.drawer_caption": "镇座火神 · HINOKAMI · 多伦多",
  "nav.open_menu": "打开菜单",
  "nav.close_menu": "关闭菜单",
  "nav.social_instagram": "Instagram",
  "nav.social_facebook": "Facebook",
  ...
  "gallery.heading": "画廊",
  "gallery.subheading": "十六年的炉火，盛于一盘之上。",
  "gallery.filter_all": "全部",
  "gallery.filter_cuisine": "料理",
  "gallery.filter_atmosphere": "店内",
  "gallery.filter_chef": "主厨",
  "gallery.image_coming_soon": "图片即将上传",
  "gallery.cat.cuisine": "料理",
  "gallery.cat.atmosphere": "店内",
  "gallery.cat.chef": "主厨",
  "gallery.prev": "上一张",
  ...
  "concierge.continue_reservation_assistant": "继续至预订助手 →",

  "ra.step1_prompt": "请选择您希望来店的日期。",
  "ra.step2_prompt": "您希望几点光临?",
  "ra.step3_prompt": "您共有几位? (1-8位)",
  "ra.step4_prompt": "请选择您喜欢的座位类型。",
  "ra.step5_prompt": "请提供您的联系方式。",
  "ra.step6_prompt": "有过敏、纪念日、无障碍需求、饮食偏好等请告诉我们。",
  "ra.step6_placeholder": "生日庆祝、花生过敏等",
  "ra.step7_prompt": "请确认您的预订内容:",
  "ra.label_name": "姓名",
  "ra.label_email": "邮箱",
  "ra.label_phone": "电话 (选填)",
  "ra.continue": "继续 →",
  "ra.back": "← 返回",
  "ra.skip": "跳过 →",
  "ra.confirm": "确认预订 →",
  "ra.confirming": "确认中…",
  "ra.cancel_note": "24小时前可免费取消。24小时内: 每位 CAD $50 取消费。",
  "ra.cancel_note_private": "私人房间: 72小时前免费取消，72小时内50%，当日100%取消费。",
  "ra.seat.counter_name": "吧台主厨推荐",
  "ra.seat.counter_capacity": "1-2位",
  "ra.seat.counter_price": "CAD $135-175 / 每位",
  "ra.seat.counter_desc": "稻草烈焰前排席。主厨主导8道菜套餐。",
  "ra.seat.table_name": "餐桌席",
  "ra.seat.table_capacity": "2-6位",
  "ra.seat.table_price": "CAD $70-100 / 每位",
  "ra.seat.table_desc": "开放式餐厅，4-5道菜分享。",
  "ra.seat.private_name": "私人榻榻米房间",
  "ra.seat.private_capacity": "4-8位",
  "ra.seat.private_price": "CAD $90-130 / 每位 + 房间费 $30",
  "ra.seat.private_desc": "障子门私人房间，推荐主厨套餐。",
  "ra.summary.date": "日期",
  "ra.summary.time": "时间",
  "ra.summary.party": "人数",
  "ra.summary.seating": "座位",
  "ra.summary.name": "姓名",
  "ra.summary.email": "邮箱",
  "ra.summary.phone": "电话",
  "ra.summary.requests": "特殊要求",
  "ra.result_heading": "预订已确认",
  "ra.result_body": "已为您预订 {date} {time} {seating}，共 {party_size} 位。确认邮件已发送至 {email}。",
  "ra.result_confirmation_num": "预订编号 #{conf_num}",
  "ra.result_next_steps": "需要详细的过敏原检查吗? 请说\"过敏原\"，我会打开 Order Assistant。",
  "ra.result_close": "完成",
  "ra.mock_notice": "(仅为演示 — 不会实际登记预订)",
  "ra.guest_one": "{n} 位",
  "ra.guest_many": "{n} 位",
  "ra.party_label": "人数",
};
